...
def LncADeepGetFeature(seq):
    ...
    fickett_fea = "\t".join(
        [str(A_pos_fea), str(C_pos_fea), str(G_pos_fea), str(T_pos_fea), str(base_ratio[0]), str(base_ratio[1]),
    ...
    feature_name = ['EDP_fea_A', 'EDP_fea_C', 'EDP_fea_D', 'EDP_fea_E', 'EDP_fea_F',
                    ...
                    'Kmer_EDP_ORF_TT', 'UTR5_perc_len', 'UTR5_GC_content', 'UTR3_perc_len', 'UTR3_GC_content',
                    'A_pos_fickett',
